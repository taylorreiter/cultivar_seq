...
jgi_names_key<-read.csv("JGI_names/jgi_names2.csv")
...
Oe6_fungi_k31_s1k <-read.csv("Oe6_scaled_1000/fungi_k31__s1000_Oe6.scaffolds.fa.txt.csv", header = T)
Oe6_fungi_k51_s1k <-read.csv("Oe6_scaled_1000/fungi_k51__s1000_Oe6.scaffolds.fa.txt.csv", head = T)
