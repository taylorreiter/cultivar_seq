...
```
Compute signatures again, this time with `--scaled 1000`, and with all three k values
```
cd fungal_sigs
...
Compute signatures again, this time with `--scaled 1000` and with k 21, 31, 51
```
